                ...
                .subscribe(
                        ...
                        { response ->
                            ...
                            if (response.isSuccessful) {
                                ...
                                FirebaseMessagingManager.registerFirebaseMessaging(response.body()?.token!!, FirebaseInstanceId.getInstance().token)

                                //Toast.makeText(this,body.currentAccount.status,Toast.LENGTH_LONG).show()


                                startActivity(getCorrectIntent(body.currentAccount, applicationContext, true))
                            } else {
