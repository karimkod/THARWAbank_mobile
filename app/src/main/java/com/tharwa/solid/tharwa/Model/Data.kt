...
data class VirementExtern
(
    @SerializedName("num_acc_receiver") val numAccount: Int,
    @SerializedName("code_bnk_receiver") val codeBankReceiver: String,
    @SerializedName("code_curr_receiver") val codeCurrency: String,
    @SerializedName("name") val nameReceiver: String,
    @SerializedName("amount_virement") val amount: Float
